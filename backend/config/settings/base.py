...
# AI_SERVICE_URL      — Full URL to the ai_service FastAPI service.
#                         In Docker this resolves to http://ai_service:8001.
...
AI_SERVICE_URL = env(
    "AI_SERVICE_URL",
    default="http://ai_service:8001/api/v1/rank-tasks",
)
