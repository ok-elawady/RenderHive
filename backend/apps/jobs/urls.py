...
from .views import DependencyViewSet, JobViewSet, LayerViewSet, RecentDispatchesView, TaskDispatchView, TaskViewSet, explain_log_view
...
urlpatterns = (
    [
        ...
        path("logs/explain/", explain_log_view, name="log-explain"),
    ]
    + router.urls
    + jobs_router.urls
    + layers_router.urls
