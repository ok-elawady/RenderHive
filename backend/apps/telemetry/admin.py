...
class TaskExecutionLogAdmin(admin.ModelAdmin):
    list_display = ("task", "job", "attempt_number", "worker_hostname", "exit_status", "duration_seconds", "created_at")
...
class FarmEventAdmin(admin.ModelAdmin):
    list_display = ("event_type", "severity", "actor_username", "target_type", "target_id", "message", "created_at")
