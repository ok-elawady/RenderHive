...
from renderhive_houdini.ui.qt_compat import QtCore, QtGui, QtSvg
...
def icon_path(filename):
    ...
    candidates = [
        ...
        os.path.join(os.path.dirname(base_dir), "icons", filename),
        os.path.join(os.path.dirname(os.path.dirname(base_dir)), "icons", filename),
        os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(base_dir))), "icons", filename),
    ]
