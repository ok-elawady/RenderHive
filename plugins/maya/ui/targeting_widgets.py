...
class RenderLayerSelector(QtWidgets.QFrame):
    ...
    def __init__(self, parent=None):
        ...
        renderable_button.setCursor(QtCore.Qt.PointingHandCursor)
        renderable_button.setFixedHeight(24)
        renderable_button.setStyleSheet("font-size: 11px; padding: 0 8px;")
        ...
        all_button.setCursor(QtCore.Qt.PointingHandCursor)
        all_button.setFixedHeight(24)
        all_button.setStyleSheet("font-size: 11px; padding: 0 8px;")
        ...
        none_button.setCursor(QtCore.Qt.PointingHandCursor)
        none_button.setFixedHeight(24)
        none_button.setStyleSheet("font-size: 11px; padding: 0 8px;")
        none_button.clicked.connect(self.clear_all)
        tools.addWidget(none_button)

        refresh_button = QtWidgets.QPushButton("Refresh")
        refresh_button.setObjectName("SecondaryBtn")
        refresh_button.setCursor(QtCore.Qt.PointingHandCursor)
        refresh_button.setFixedHeight(24)
        refresh_button.setStyleSheet("font-size: 11px; padding: 0 8px;")
